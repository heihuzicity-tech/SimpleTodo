...
export const KanbanCard = memo(function KanbanCard({ card, onUpdate, onDelete, onClick, onDragStart, onDragEnd }: KanbanCardProps) {
  ...
  useEffect(() => {
    if (isDragging && !wasDragging) {
      ...
      // onDragEnd is already called in the end callback
    }
            ...
            {isEditing ? (
              ...
              <>
                <div className="mb-1.5">
                  <h4 className={`leading-tight break-words break-all overflow-wrap-anywhere transition-all duration-200 ${
                ...
                {card.description && (
                  <p className={`text-sm mb-3 leading-relaxed break-words break-all overflow-wrap-anywhere transition-all duration-200 ${
                ...
                <div className="flex items-center justify-between">
                  <span className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium transition-all duration-200 ${
                    card.completed 
                      ? 'bg-green-600 text-white border border-green-600 shadow-sm hover:bg-green-700 dark:bg-green-500 dark:text-white dark:border-green-500 dark:hover:bg-green-400' 
